...
public final class ClanPromoteCommand extends ClanCommand {
    ...
    public void execute(Player player, String... args) {
        if (args.length != 1) {
            this.messages.sendCommandUsage(player, "promote <Spieler>");
            return;
        }
        ...
        this.playerRepository.setRole(
            ...
            this.messages.sendMessage(targetName, "received_promote");
            this.messages.sendMessage(player, "promoted_target", targetName);
        });
    }
}
